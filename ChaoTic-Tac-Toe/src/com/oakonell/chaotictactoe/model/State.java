...
public class State {
	...
	private final Marker lastPlayer;
	...
	public static State winner(Cell start, Cell end, Marker winner, int score, WinStyle winStyle) {
		return new State(start, end, winner, score, SimpleState.WIN, winStyle);
	}
	public static State draw(Marker player) {
		return new State(null, null, player, 0, SimpleState.DRAW, null);
	}
	public static State open(Cell start, Cell end, Marker player, int score) {
		return new State(start, end, player, score, SimpleState.OPEN, null);
	}
	
	public State(Cell start, Cell end, Marker winner, int score, SimpleState state, WinStyle winStyle) {
