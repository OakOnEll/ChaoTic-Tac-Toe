...
package com.oakonell.chaotictactoe.googleapi;
...
//        mHelper = new GameHelper(this);
    ...
    protected void onCreate(Bundle b) {
		...
		mHelper = ((ChaoTicTacToe)getApplication()).getGameHelper();
		if (mHelper == null) {
	        mHelper = new GameHelper(this);
	        ((ChaoTicTacToe)getApplication()).setGameHelper(mHelper);
	        mHelper.setup(this, mRequestedClients);
		}  else {
			mHelper.setup(this, 0);
		}
    }
